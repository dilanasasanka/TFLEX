...
export class MenComponent implements OnInit{
  ...
  ngOnInit(): void {
    this.productService.getProductsByCategory('men-cf').subscribe((data) => {
      this.products_cf = data;
    });

    this.productService.getProductsByCategory('men-ps').subscribe((data) => {
      this.products_ps = data;
    });
  }
